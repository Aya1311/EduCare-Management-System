...
@WebServlet("/DeleteMessageProfServlet")
public class DeleteMessageProfServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            response.sendRedirect("dashboard_prof.jsp?profId=" + idRecepteur);
        } catch (Exception e) {
            if (connection != null) {
                try {
                    connection.rollback();
