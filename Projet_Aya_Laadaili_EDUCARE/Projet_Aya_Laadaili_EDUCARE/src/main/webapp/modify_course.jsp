...
<div class="container">
    ...
    <form action="update_course" method="post">
        ...
        <input type="hidden" name="secretaireId" value="<%= secretaireId %>">
        ...
        <!-- Champ pour sélectionner la salle disponible -->
        <div class="form-group">
    ...
    <!-- Bouton de redirection pour retourner à la liste des cours ou à une page spécifique -->
    <a href="list_cours_sec.jsp?secretaireId=<%= request.getParameter("secretaireId") %>" class="btn btn-primary">Retour à la liste des cours</a>
