...
@WebServlet("/DeleteMessageSecServlet")
public class DeleteMessageSecServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            response.sendRedirect("dashboard_secraitaire.jsp?secretaireId=" + idRecepteur);
        } catch (Exception e) {
            if (connection != null) {
                try {
                    connection.rollback();
