...
<%
    ...
    try {
        ...
        String query = "SELECT e.*, n.niveau,f.nom_filiere FROM etudiant e JOIN niveau n ON e.id_niveau = n.id_niveau JOIN filiere f ON e.id_filiere=f.id_filiere WHERE e.id_etudiant = ?";
...
<li class="breadcrumb-item active" ><a href="etudiant_profile.jsp?studentId=<%= idE %>">User Profile</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <a class="btn btn-info " target="__blank" href="settings.jsp?studentId=<%= idE %>">Edit</a>
        </div>
    </div>
</div>
</div>
